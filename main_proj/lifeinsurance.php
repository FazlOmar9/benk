...
<body>
    ...
    <div class="transfer-container" style="height: 700px;">
        <h2 class="font-weight-bold mb-4">Life Insurance Application</h2>
        <hr>
            ...
            <tr>
                ...
                <td>
                    <select id="insurancePlan">
                        <option value="basic">Basic (30 lacs)</option>
                        <option value="standard">Standard (50 lacs)</option>
                        <option value="premium">Premium (1 cr)</option>
                    </select>
                </td>
            </tr>
            <tr>
...
<script>
    ...
    function bruh(){
        ...
        window.location.href = "lifeinsurance.php";
    }
</script>
